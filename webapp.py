...
# # Language settings for output speech
# SUPPORTED_LANGUAGES = ("en", "hi", "kn")
# CURRENT_LANGUAGE = "en"  # change to "hi" or "kn" if you want Hindi/Kannada responses

# LANG_TO_VOSK_MODEL = {
#     "en": "models/vosk_en",
#     "hi": "models/vosk_hi",   # only works if you download a Hindi Vosk model
#     "kn": "models/vosk_kn",   # placeholder for Kannada model
# }
...
# # ================== TEXT TEMPLATES (MULTILINGUAL) ==================

# def tr(key: str) -> str:
#     texts = {
#         "HELLO": {
#             "en": "Hello, I am your AI assistant. How can I help you?",
#             "hi": "नमस्ते, मैं आपका एआई सहायक हूँ। मैं आपकी कैसे मदद कर सकता हूँ?",
#             "kn": "ನಮಸ್ಕಾರ, ನಾನು ನಿಮ್ಮ AI ಸಹಾಯಕ. ನಾನು ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಲಿ?",
#         },
#         "HOW_ARE_YOU": {
#             "en": "I am just code, but I am running fine. How are you?",
#             "hi": "मैं सिर्फ कोड हूँ, लेकिन ठीक से चल रहा हूँ। आप कैसे हैं?",
#             "kn": "ನಾನು ಕೇವಲ ಕೋಡ್, ಆದರೆ ಚೆನ್ನಾಗಿ ಕೆಲಸ ಮಾಡುತ್ತಿದ್ದೇನೆ. ನೀವೇ ಹೇಗಿದ್ದೀರಾ?",
#         },
#         "START_TALKING_ON": {
#             "en": "Got it. I will describe the scene and people for you.",
#             "hi": "ठीक है, मैं आपके लिए आसपास का दृश्य और लोगों का वर्णन करूँगा।",
#             "kn": "ಸರಿ, ನಾನೀಗ ನಿಮಗೆ ಸುತ್ತಮುತ್ತ ಇರುವ ದೃಶ್ಯ ಮತ್ತು ಜನರ ಬಗ್ಗೆ ಹೇಳುತ್ತೇನೆ.",
#         },
#         "STOP_LISTENING": {
#             "en": "Okay, I will stop listening until you say start listening.",
#             "hi": "ठीक है, जब तक आप 'स्टार्ट लिसनिंग' नहीं कहेंगे, तब तक मैं नहीं सुनूँगा।",
#             "kn": "ಸರಿ, ನೀವು 'ಸ್ಟಾರ್ಟ್ ಲಿಸನಿಂಗ್' ಎಂದು ಹೇಳುವವರೆಗೂ ನಾನು ಕೇಳುವುದಿಲ್ಲ.",
#         },
#         "START_LISTENING": {
#             "en": "I am listening again.",
#             "hi": "अब मैं फिर से सुन रहा हूँ।",
#             "kn": "ಈಗ ನಾನು ಮತ್ತೆ ಕೇಳುತ್ತೇನೆ.",
#         },
#         "STOP_DETECTION": {
#             "en": "I have turned off visual detection.",
#             "hi": "मैंने विज़ुअल डिटेक्शन बंद कर दिया है।",
#             "kn": "ನಾನು ದೃಶ್ಯ ಪತ್ತೆಯನ್ನು ಆಫ್ ಮಾಡಿದ್ದೇನೆ.",
#         },
#         "START_DETECTION": {
#             "en": "I have turned visual detection back on.",
#             "hi": "मैंने विज़ुअल डिटेक्शन फिर से चालू कर दिया है।",
#             "kn": "ನಾನು ದೃಶ್ಯ ಪತ್ತೆಯನ್ನು ಮತ್ತೆ ಆನ್ ಮಾಡಿದ್ದೇನೆ.",
#         },
#         "WEATHER": {
#             "en": "I am offline, but I hope the weather is nice where you are.",
#             "hi": "मैं ऑफलाइन हूँ, लेकिन आशा करती हूँ कि आपके यहाँ मौसम अच्छा होगा।",
#             "kn": "ನಾನು ಆಫ್‌ಲೈನ್‌ನಲ್ಲಿ ಇದ್ದೇನೆ, ಆದರೆ ನಿಮ್ಮ ಬಳಿ ಹವಾಮಾನ ಚೆನ್ನಾಗಿದೆ ಎಂದು ಭಾವಿಸುತ್ತೇನೆ.",
#         },
#         "ASSISTANT_STARTED": {
#             "en": "Vision assistant started.",
#             "hi": "विज़न असिस्टेंट शुरू हो गया है।",
#             "kn": "ವಿಷನ್ ಸಹಾಯಕ ಪ್ರಾರಂಭವಾಗಿದೆ.",
#         },
#         "ASSISTANT_STOPPED": {
#             "en": "Vision assistant stopped.",
#             "hi": "विज़न असिस्टेंट बंद हो गया है।",
#             "kn": "ವಿಷನ್ ಸಹಾಯಕ ನಿಲ್ಲಿಸಲಾಗಿದೆ.",
#         },
#         "SHUTDOWN": {
#             "en": "Shutting down vision assistant.",
#             "hi": "विज़न असिस्टेंट को बंद किया जा रहा है।",
#             "kn": "ವಿಷನ್ ಸಹಾಯಕವನ್ನು ಈಗ ನಿಲ್ಲಿಸಲಾಗುತ್ತಿದೆ.",
#         },
#     }
#     lang = CURRENT_LANGUAGE if CURRENT_LANGUAGE in SUPPORTED_LANGUAGES else "en"
...
# stt_model_path = LANG_TO_VOSK_MODEL.get(CURRENT_LANGUAGE, "models/vosk_en")
# stt = SpeechToTextListener(model_path=stt_model_path)
...
# # Visual commands set (for gating when detection is OFF)
# VISION_COMMANDS = {
...
#     # Start talking again (also wake listening)
#     elif cmd == CommandType.START_TALKING:
#         auto_talk_flag = True
#         voice_flag = True
#         listening_flag = True
#         response = tr("START_TALKING_ON")

#     # Listening control
#     elif cmd == CommandType.STOP_LISTENING:
#         listening_flag = False
#         if voice_flag:
#             response = tr("STOP_LISTENING")

#     elif cmd == CommandType.START_LISTENING:
#         listening_flag = True
#         if voice_flag:
#             response = tr("START_LISTENING")

#     # Detection control
#     elif cmd == CommandType.STOP_DETECTION:
#         detection_flag = False
#         if voice_flag:
#             response = tr("STOP_DETECTION")

#     elif cmd == CommandType.START_DETECTION:
#         detection_flag = True
#         if voice_flag:
#             response = tr("START_DETECTION")
...
#     global cap, assistant_running, auto_talk, listening_enabled, detection_enabled, voice_enabled
#     global last_auto_scene_time, last_spoken, latest_detections, latest_persons
#     global face_state, frame_count, last_command_text, reload_faces_pending, stt
...
#         # ---- Handle pending face reload (pause everything including STT) ----
#         if reload_faces_pending:
#             reload_faces_pending = False
...
#             try:
#                 logbuffer.add("[web] Reloading faces from folder (assistant paused).")
#                 # stop STT microphone while reloading to avoid input overflow
#                 try:
#                     stt.stop()
#                 except Exception as e:
#                     logbuffer.add(f"[web] Error stopping STT before reload: {e}")
...
#                 logbuffer.add(msg)
#             finally:
#                 # restart STT listener
#                 try:
#                     stt.start()
#                 except Exception as e:
#                     logbuffer.add(f"[web] Error restarting STT after reload: {e}")
...
#             # ----- Voice commands (always read STT queue, but gate actions) -----
#             recognized_text = stt.get_latest_command()
#             if recognized_text:
#                 last_command_text = recognized_text
#                 msg = f"[web][MAIN] User said: {recognized_text!r}"
...
#                     # 2) If detection is OFF, ignore vision-related commands
...
#         logbuffer.add("[web] Assistant started.")
#         if voice_enabled:
#             tts.speak(tr("ASSISTANT_STARTED"))
#     return redirect(url_for("index"))
...
#         logbuffer.add("[web] Assistant stopped.")
#         if voice_enabled:
#             tts.speak(tr("ASSISTANT_STOPPED"))
#     return redirect(url_for("index"))
...
#     logbuffer.add("[web] Shutting down vision assistant.")
#     if voice_enabled:
#         tts.speak(tr("SHUTDOWN"))
#     return "Shutting down."


# if __name__ == "__main__":
#     # start STT when running webapp directly
#     stt.start()
...
# SUPPORTED_LANGUAGES = ("en", "hi", "kn")
# CURRENT_LANGUAGE = "en"  # "en" / "hi" / "kn"

# LANG_TO_VOSK_MODEL = {
#     "en": "models/vosk_en",
#     "hi": "models/vosk_hi",   # you need to place Hindi model here if you want
#     "kn": "models/vosk_kn",   # placeholder for Kannada model
# }
...
#         auto_talk_flag = False
#         voice_flag = False
#         # fully mute, so no spoken response here
...
# def generate_frames():
#     global cap, assistant_running, auto_talk, listening_enabled, detection_enabled, voice_enabled, stt
#     global last_auto_scene_time, last_spoken, latest_detections, latest_persons
#     global face_state, frame_count, last_command_text, reload_faces_pending
...
#         # ---- Handle pending face reload (PAUSE EVERYTHING while reloading) ----
#         if reload_faces_pending:
#             reload_faces_pending = False
...
#             try:
#                 logbuffer.add("[web] Pausing all modules to reload faces.")
#                 # STOP microphone listener so no 'input overflow'
#                 try:
#                     stt.stop()
#                 except Exception as e:
#                     logbuffer.add(f"[web] Error stopping STT before reload: {e}")

#                 # heavy work: load encodings
#                 logbuffer.add("[web] Reloading faces from folder (assistant paused).")
#                 vision._load_known_faces(FACES_FOLDER)
#                 logbuffer.add("[web] Faces reloaded successfully.")
#             except Exception as e:
...
#             "assistant_running": assistant_running,
#             "listening_enabled": listening_enabled,
#             "listening": listening_enabled,  # simple alias for frontend
#             "detection_enabled": detection_enabled,
#             "last_command": last_command_text,
#             "last_spoken": last_spoken,
#         }
...
listening_enabled: bool = True
detection_enabled: bool = True
voice_enabled: bool = True      # master audio mute
...
# Visual commands to block when detection is off
VISION_COMMANDS = {
    CommandType.DESCRIBE_SCENE,
    CommandType.READ_TEXT,
    CommandType.WHO_IS_HERE,
...
def handle_command(
    ...
    # Start talking again
        ...
        auto_talk_flag = True
        voice_flag = True
        listening_flag = True  # also wake listening
        response = "Got it. I will describe the scene and people for you."
...
def generate_frames():
    ...
    while True:
        ...
        # ---- Handle pending face reload (PAUSE EVERYTHING + STT) ----
        if reload_faces_pending:
            reload_faces_pending = False
            ...
            try:
                logbuffer.add("[web] Pausing modules to reload faces.")
                try:
                    stt.stop()
                except Exception as e:
                    logbuffer.add(f"[web] Error stopping STT before reload: {e}")

                logbuffer.add("[web] Reloading faces from folder...")
                vision._load_known_faces(FACES_FOLDER)
                logbuffer.add("[web] Faces reloaded successfully.")
            except Exception as e:
                msg = f"[web] Error while reloading faces: {e}"
        ...
        if assistant_running:
            ...
            # ----- Voice commands (ALWAYS read queue) -----
            recognized_text = stt.get_latest_command()
            if recognized_text:
                last_command_text = recognized_text
                msg = f"[web][MAIN] User said: {recognized_text!r}"
                ...
                try:
                    ...
                    # listening OFF -> only wake words work
                    if not listening_enabled and cmd not in (
                        CommandType.START_LISTENING,
                        CommandType.START_TALKING,
                    ):
                    ...
                    # detection OFF -> ignore visual commands
                    if not detection_enabled and cmd in VISION_COMMANDS:
                        cmd = CommandType.NONE
    ...
    return jsonify(
        {
            "assistant_running": assistant_running,
            "listening_enabled": listening_enabled,
            "listening": listening_enabled,  # alias for JS
            "detection_enabled": detection_enabled,
            "last_command": last_command_text,
            "last_spoken": last_spoken,
        }
...
def upload_face():
    """
    Save face image and ask camera thread to reload encodings.
    Heavy work is done in generate_frames() to avoid crashes.
    """
    global reload_faces_pending
...
if __name__ == "__main__":
    try:
        logbuffer.add("[web] Starting STT and web server...")
        stt.start()
        if voice_enabled:
            tts.speak("Web interface is ready.")
        app.run(host="0.0.0.0", port=5000, debug=False)
