...
class RecognizedPerson:
    name: str               # known name or "Unknown"
    emotion: Optional[str]  # e.g. "happy", "sad", "neutral", or None
    bbox: Tuple[int, int, int, int]  # (x1, y1, x2, y2)
...
class VisionSystem:
    def __init__(
        ...
        # Only talk about these classes – keeps description meaningful
    ...
    def read_text_from_frame(
        ...
        # Slight blur to reduce noise (optional)
        gray = cv2.GaussianBlur(gray, (3, 3), 0)

        # EasyOCR accepts grayscale arrays directly
